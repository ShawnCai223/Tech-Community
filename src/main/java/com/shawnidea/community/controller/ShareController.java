...
@Controller
public class ShareController implements AppConstants {
    ...
    public String share(String htmlUrl) {
        // 文件名
        String fileName = AppUtil.generateUUID();
        ...
        map.put("shareUrl", objectStorageService.getShareUrl(fileName));

        return AppUtil.getJSONString(0, null, map);
    }
