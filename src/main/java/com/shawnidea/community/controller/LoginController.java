...
public class LoginController implements AppConstants {
    ...
    public String register(Model model, User user) {
        ...
        if (map == null || map.isEmpty()) {
            model.addAttribute("msg", "Registration successful. We have sent an activation email to your inbox.");
    ...
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code) {
        ...
        if (result == ACTIVATION_SUCCESS) {
            model.addAttribute("msg", "Activation successful. Your account is now active.");
            model.addAttribute("target", "/login");
        } else if (result == ACTIVATION_REPEAT) {
            model.addAttribute("msg", "Invalid operation. This account has already been activated.");
            model.addAttribute("target", "/index");
        } else {
            model.addAttribute("msg", "Activation failed. The activation code is invalid.");
            model.addAttribute("target", "/index");
        }
        return "/site/operate-result";
    }
