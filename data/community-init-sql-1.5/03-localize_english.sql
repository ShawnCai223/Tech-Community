...
SET username = CASE id
    ...
    END,
    header_url = CASE id
        WHEN 11 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 12 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 13 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 21 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 22 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 23 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 24 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 25 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 101 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 102 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 103 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 111 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 112 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 113 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 114 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 115 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 116 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 117 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 118 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 119 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 120 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 121 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 122 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 123 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 124 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 125 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 126 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 127 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 128 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 129 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 131 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 132 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 133 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 134 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 137 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 138 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 144 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 145 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 146 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        WHEN 149 THEN 'http://localhost:8080/community/img/avatar-default.svg'
        ELSE header_url
    END
WHERE id <> 1;
